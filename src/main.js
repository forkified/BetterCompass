...
if (
  ...
  JSON.parse(import.meta.env.VITE_APP_SENTRY_ENABLED)
) {
  Sentry.init({
    Vue,
...
if (JSON.parse(import.meta.env.VITE_APP_MATOMO_ENABLED)) {
  Vue.use(VueMatomo, {
    ...
    host: import.meta.env.VITE_APP_MATOMO_URL,
    siteId: import.meta.env.VITE_APP_MATOMO_SITE_ID,

    // Changes the default .js and .php endpoint's filename
    // Default: 'matomo'
    trackerFileName: import.meta.env.VITE_APP_MATOMO_TRACKER,
    ...
    // Default: undefined, example: '*.example.com'
    domains: import.meta.env.VITE_APP_MATOMO_DOMAINS,
